...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(DRV8316nSCS_GPIO_Port, DRV8316nSCS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, nSLEEP_Pin|DRVOFF_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : DRV8316nSCS_Pin */
  GPIO_InitStruct.Pin = DRV8316nSCS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(DRV8316nSCS_GPIO_Port, &GPIO_InitStruct);
